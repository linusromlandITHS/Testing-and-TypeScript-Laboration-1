...
const AUTH0_DOMAIN: string = process.env.PUB_AUTH0_DOMAIN;
const AUTH0_CLIENT_ID: string = process.env.PUB_AUTH0_CLIENT_ID;
...
const QUESTION_MAX_PLAYERS: number = Number(process.env.QUESTION_MAX_PLAYERS) || 5;
